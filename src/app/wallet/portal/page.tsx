    ...
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-10 px-5 py-16 md:px-8">
        <div className="space-y-3 text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-white md:text-4xl">Ingresa a tu wallet</h1>
          <p className="text-sm text-gray-400">
            Inicia sesión usando el número con el que registraste tu wallet. Te enviaremos un código por WhatsApp para entrar.
          </p>
        </div>
        <WalletOtpPortal />
      </div>
